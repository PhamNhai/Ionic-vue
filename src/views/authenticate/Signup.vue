  ...
  <div class="ion-page">
    ...
    <ion-content class="ion-padding">
      ...
      <form>
        <ion-list>
          <ion-item>
            <ion-label position="stacked" color="primary">Full Name<ion-text color="danger"> *</ion-text>
            </ion-label>
            <ion-input type="text" spellcheck="false" autocapitalize="off" required :value="name"
              @change="name = $event.target.value"></ion-input>
          </ion-item>
          <ion-item>
            <ion-label position="stacked" color="primary">Nickname<ion-text color="danger"> *</ion-text>
            </ion-label>
            <ion-input type="text" spellcheck="false" autocapitalize="off" required :value="username"
              @change="username = $event.target.value"></ion-input>
          </ion-item>
          <ion-item>
